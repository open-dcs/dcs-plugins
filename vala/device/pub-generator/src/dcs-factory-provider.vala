public class Dcs.PubGenFactory : GLib.Object, Dcs.FooFactory {
...
public class Dcs.PubGenFactoryProvider : GLib.Object, Dcs.FactoryProvider {

    public Dcs.FooFactory factory { get; construct set; }

    construct {
        factory = new Dcs.PubGenFactory ();
    }
}
